...
const Selisih15 = () => {
    ...
    useEffect(() => {
      const fetchDataAsync = async () => {
        const data1 = await fetchData('http://localhost:3001/api/tipekendaraan/pajak123rupiah');
        const data2 = await fetchData('http://localhost:3001/api/tipekendaraan/xpajak123rupiah');
    ...
    return(
        <TitleCard title={"Selisih Realisasi dan Target Pajak"}>
             {/** Table Data */}
